...
//	GPIO_voidSetPinValue(GPIO_PORTA, 9, GPIO_LOW);
	switch ((temp/10)){
	case 0:
		S_sendData(GPIO_PORTA,0,3,2,SevSeg[0]);
	break;
	case 1:
		S_sendData(GPIO_PORTA,0,3,2,SevSeg[1]);
	break;
	case 2:
		S_sendData(GPIO_PORTA,0,3,2,SevSeg[2]);
	break;
	case 3:
		S_sendData(GPIO_PORTA,0,3,2,SevSeg[3]);
	break;
	case 4:
		S_sendData(GPIO_PORTA,0,3,2,SevSeg[4]);
	break;
	case 5:
		S_sendData(GPIO_PORTA,0,3,2,SevSeg[5]);
	break;
	case 6:
		S_sendData(GPIO_PORTA,0,3,2,SevSeg[6]);
	break;
	case 7:
		S_sendData(GPIO_PORTA,0,3,2,SevSeg[7]);
	break;
	case 8:
		S_sendData(GPIO_PORTA,0,3,2,SevSeg[8]);
	break;
	case 9:
		S_sendData(GPIO_PORTA,0,3,2,SevSeg[9]);
	break;
	}
}
