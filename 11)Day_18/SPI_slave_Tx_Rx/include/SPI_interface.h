...
void SPI_tx_close_interrupt(SPI_REG_t *SPIx);

void SPI_rx_close_interrupt(SPI_REG_t *SPIx);
...
void 	i2c_spi_irq_handler(SPI_REG_t *SPIx);

void SPI_hanlde_rx_interrupt(SPI_REG_t *SPIx);


void SPI_hanlde_tx_interrupt(SPI_REG_t *SPIx);
