...
void DMA_voidEnableInterrupt(u8 channel_number,u8 DMAx_Channelx_IRQn){
...
void DMA_voidIncrementPer(u8 channel_number){
	SET_BIT(DMA->channel[channel_number].CCR,6);
}

void DMA_voidIncrementMem(u8 channel_number){
	SET_BIT(DMA->channel[channel_number].CCR,7);
}

void DMA_voidClearIncrementPer(u8 channel_number){
	CLR_BIT(DMA->channel[channel_number].CCR,6);
}

void DMA_voidClearIncrementMem(u8 channel_number){
	CLR_BIT(DMA->channel[channel_number].CCR,7);
}
