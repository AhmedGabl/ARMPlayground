...
u8 GPIO_u8GetPinValue(u8 Copy_u8Port, u8 Copy_u8Pin){
	...
	switch(Copy_u8Port){
	case GPIO_PORTA:
		temp_u8ReturnVal = (u8)GET_BIT(REG_GPIO_PORTA->IDR,Copy_u8Pin);
		break;
	case GPIO_PORTB:
		temp_u8ReturnVal =(u8) GET_BIT(REG_GPIO_PORTB->IDR,Copy_u8Pin);
		break;
	case GPIO_PORTC:
		temp_u8ReturnVal =(u8) GET_BIT(REG_GPIO_PORTC->IDR,Copy_u8Pin);
		break;
	}
